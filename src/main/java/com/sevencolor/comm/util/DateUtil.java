...
public class DateUtil {
  ...
  public final static String DATE_FROMAT_STRING20 = "dd/MMM/yyy:HH:mm:ss Z";
  public final static String DATE_FROMAT_STRING21 = "MMM dd,yyyy HH:mm:ss a z";
  public final static String DATE_FROMAT_STRING22 = "dd MMM, yyyy HH:mm:ss a z";
  public final static String DATE_FROMAT_STRING23 = "dd-MMM-yy HH:mm:ss a z";
  public final static String DATE_FROMAT_STRING24 = "dd MMM yyyy HH:mm:ss z";
  public final static String DATE_FROMAT_STRING25 = "MMM dd yyyy HH:mm:ss z";
  public final static String DATE_FROMAT_STRING26 = "dd.MM.yyyy HH:mm:ss z";
  ...
  public final static DateFormat format_yyyyMMdd_HHmmss =
      new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
  public final static DateFormat format_yyyyMMddHHmmssSSS =
      new SimpleDateFormat(FROMAT_yyyyMMddHHmmssSSS);
  ...
  public final static DateFormat format9 =
      new SimpleDateFormat(DATE_FROMAT_STRING9, Locale.ENGLISH);
  ...
  public final static DateFormat format15 = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
  public final static DateFormat format16 = new SimpleDateFormat("yyyyMMdd");
  public final static DateFormat format17 = new SimpleDateFormat("yyyy-MM-dd'T'HH");
  public final static DateFormat format18 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ssSSS");
  public final static DateFormat format19 = new SimpleDateFormat("yyyy/MM/dd");
  public final static DateFormat format20 =
      new SimpleDateFormat(DATE_FROMAT_STRING20, Locale.ENGLISH);
  public final static DateFormat format21 =
      new SimpleDateFormat(DATE_FROMAT_STRING21, Locale.ENGLISH);
  public final static DateFormat format22 =
      new SimpleDateFormat(DATE_FROMAT_STRING22, Locale.ENGLISH);
  public final static DateFormat format23 =
      new SimpleDateFormat(DATE_FROMAT_STRING23, Locale.ENGLISH);
  public final static DateFormat format24 =
      new SimpleDateFormat(DATE_FROMAT_STRING24, Locale.ENGLISH);
  public final static DateFormat format25 =
      new SimpleDateFormat(DATE_FROMAT_STRING25, Locale.ENGLISH);
  public final static DateFormat format26 =
      new SimpleDateFormat(DATE_FROMAT_STRING26, Locale.ENGLISH);
  ...
  public final static String[] Holidays =
      new String[] {"1-1", "5-5-1", "7-4", "9-1-1", "10-4-1", "11-4-4", "12-25"};
  ...
  /**
   * 将任意格式的String类型的日期转换成Date (目前支持系统中已经定义的所有日期格式)
   * 
   * @param dateString 要转换的日期
   * @return
   */
  public static Date transformStrToDate(String dateString) throws ParseException {
    ...
    if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING1)
        && dateString.contains(DATE_SEPARATOR_COLON) && dateString.contains(DATE_SEPARATOR_MINUS)
      ...
      return date;
        ...
        && dateString.contains(DATE_SEPARATOR_MINUS) && !dateString.contains(DATE_SEPARATOR_T)) {
      dateFormat = format6;
      ...
      dateFormat = format7;
        ...
        && dateString.contains(DATE_SEPARATOR_T)) {
      dateFormat = format8;
    } else if (dateString.contains(DATE_SEPARATOR_COMMA) && !isContainsAMOrPM(dateString)) {
      date = parseDateStringToDate(format9, dateString);
      int year = transformDateToCalendar(date).get(Calendar.YEAR);
      if (year == Integer
          .parseInt(dateString.substring(dateString.length() - 4, dateString.length()))) {
        return date;
      }
      dateFormat = format9;
      ...
      int year = transformDateToCalendar(date).get(Calendar.YEAR);
      int month = transformDateToCalendar(date).get(Calendar.MONTH) + 1;
      boolean isDATE_FROMAT_STRING19 = !dateString.substring(0, 4).contains(DATE_SEPARATOR_SLASH);
      if (isDATE_FROMAT_STRING19 && year != Integer.parseInt(dateString.substring(0, 4))) {
        date = parseDateStringToDate(format19, dateString);
      } else {
        int month2 = Integer.parseInt(dateString.split(DATE_SEPARATOR_SLASH)[1]);
        if (month == month2) {
          return date;
        } else {
      ...
      return date;
        ...
        && dateString.contains(DATE_SEPARATOR_MINUS) && dateString.contains(DATE_SEPARATOR_T)
        && !isContainsAMOrPM(dateString) && !isEndWithTimeZoneAbbreviation(dateString)
        && isEndWithTimeZoneOffSetInHour(dateString)) {
      dateString = changePostFixTimeZoneFormate(dateString);
      dateFormat = format11;
    } else if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING13)
        && dateString.contains(DATE_SEPARATOR_COLON) && dateString.contains(DATE_SEPARATOR_MINUS)) {
      dateFormat = format13;
    } else if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING15)
        && dateString.contains(DATE_SEPARATOR_COLON) && dateString.contains(DATE_SEPARATOR_SLASH)) {
      dateFormat = format15;
    } else if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING16)
        && !dateString.contains(DATE_SEPARATOR_COLON) && !dateString.contains(DATE_SEPARATOR_MINUS)
        && !dateString.contains(DATE_SEPARATOR_SLASH)) {
    ...
    } else if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING17)
        && dateString.contains(DATE_SEPARATOR_MINUS) && dateString.contains(DATE_SEPARATOR_T)) {
      dateFormat = format17;
    } else if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING18)
        && dateString.contains(DATE_SEPARATOR_COLON) && dateString.contains(DATE_SEPARATOR_MINUS)) {
      dateFormat = format18;
    } else if (dateString.contains(DATE_SEPARATOR_COLON)
        && dateString.contains(DATE_SEPARATOR_SLASH)) {
      String flag = dateString.substring(dateString.length() - 5, dateString.length() - 4);
      ...
      if (day == Integer.parseInt(dateString.split(DATE_SEPARATOR_SPACE)[0])) {
        return date;
      }
  ...
  private static boolean isEndWithTimeZoneOffSetInHourLen5(String dateString) {
    String postFix = dateString.substring(dateString.length() - 5, dateString.length());
    if (postFix.length() == 5
        && (postFix.contains(DATE_SEPARATOR_PLUS) || postFix.contains(DATE_SEPARATOR_MINUS))
        && !postFix.contains(DATE_SEPARATOR_COLON)) {
      return true;
  ...
  /**
   * 将以+XX:XX(或-XX:XX)形式结尾的暁去掉其中的:替换成+XXXX(或-XXXX)形式,因为SimpleDateFormat中只有+ XXXX(或-XXXX)这种形式（用z表示）
   * 
   * @param dateString
   * @return
   */
  ...
  public static String getTimeZoneOffSetInHour(String dateString) {
    if (dateString != null
      ...
      } else if ((postFixLen5.contains(DATE_SEPARATOR_PLUS)
          || postFixLen5.contains(DATE_SEPARATOR_MINUS))
  ...
  public static long getPSTTimeZoneOffSetInMillsecond(Calendar sourceDate) {
    ...
    String timeZoneName = sourceTimeZone.getDisplayName(true, TimeZone.SHORT);
  ...
  public static String transformToPSTDateString(String dateString) throws ParseException {

    Date sourceDateTime = DateUtil.transformStrToDate(dateString);
    ...
    if (sourceDateTime.getTime() > 0) {
      long sourceDateOffSet = DateUtil.getPSTTimeZoneOffSetInMillsecond(calendar);

      sourceDateTime.setTime(sourceDateTime.getTime() - sourceDateOffSet);
    }

    String targetDateTimePST = DateUtil.Format(DateUtil.format_yyyyMMdd_HHmmss, sourceDateTime);
  ...
  public static boolean isMatchFormate21Or22(String dateString) {
    ...
    if (isContainsAMOrPM(dateString) && isEndWithTimeZoneAbbreviation(dateString)
        && dateString.contains(DATE_SEPARATOR_COLON) && dateString.contains(DATE_SEPARATOR_COMMA)
        && !dateString.contains(DATE_SEPARATOR_MINUS) && !dateString.contains(DATE_SEPARATOR_DOT)) {
      return true;
    }
    return false;
  }
  ...
  private static boolean isMatchFormate28(String dateString) {
    ...
    if (isLengthEqualDateFormatStringLength(dateString, DATE_FROMAT_STRING28)
        && isContainsAMOrPM(dateString) && !isEndWithTimeZoneAbbreviation(dateString)
        && dateString.contains(DATE_SEPARATOR_COMMA) && dateString.contains(DATE_SEPARATOR_COLON)) {
      return true;
    }
    return false;
  }
  ...
  private static boolean isMatchFormate29(String dateString) {
    ...
    if (isContainsAMOrPM(dateString) && !isEndWithTimeZoneAbbreviation(dateString)
        && isEndWithTimeZoneOffSetInHour(dateString) && dateString.contains(DATE_SEPARATOR_MINUS)
  ...
  public static boolean isMatchFormate23(String dateString) {
    ...
    if (isContainsAMOrPM(dateString) && isEndWithTimeZoneAbbreviation(dateString)
        && dateString.contains(DATE_SEPARATOR_MINUS) && !dateString.contains(DATE_SEPARATOR_COMMA)
  ...
  public static boolean isMatchFormate26(String dateString) {
    ...
    if (!isContainsAMOrPM(dateString) && isEndWithTimeZoneAbbreviation(dateString)
        && dateString.contains(DATE_SEPARATOR_DOT) && !dateString.contains(DATE_SEPARATOR_MINUS)
  ...
  private static boolean isContainsAMOrPM(String dateString) {
    ...
    if (dateString.contains(DATE_SEPARATOR_PM_LOWER_CASE)
      ...
      return true;
    } else if (dateString.contains(DATE_SEPARATOR_AM) || dateString.contains(DATE_SEPARATOR_PM)) {
      return true;
    }
    return false;
  }
  ...
  private static boolean isEndWithTimeZoneAbbreviation(String dateString) {
    if (StringUtils.isEmpty(dateString) || !dateString.contains(DATE_SEPARATOR_SPACE)) {
      return false;
    }
  ...
  /**
   * 将任意格式的String类型的日期转换成Calendar (目前支持系统中已经定义的所有日期格式)
   * 
   * @param dateString 要转换的日期
   * @return
   */
  public static Calendar transformStringDateToCalendar(String dateString) throws ParseException {
    Date date = transformStrToDate(dateString);
    Calendar calendar = Calendar.getInstance();
    calendar.setTime(date);
    return calendar;
  }
   ...
   * @return
   */
  private static boolean isLengthEqualDateFormatStringLength(String inputDateString,
      String dateFormatString) {
    return (inputDateString.length() == dateFormatString.length()
        || inputDateString.length() == dateFormatString.length() - 1
        || inputDateString.length() == dateFormatString.length() - 2);
  }
  ...
  public static int getWeekdayInterval(Date date) {
    ...
    for (int i = 0; i < d; i++) {
      ...
      if (holidays.contains(month + "-" + day)
          || holidays.contains(month + "-" + week + "-" + week_day) || week_day == 0
          || week_day == 6) {
        n++;
      }
    }
  ...
  public static int getInterval(Date date1, Date date2) {
    ...
    if (date1.compareTo(date2) < 0) {
      d = Integer.parseInt(DurationFormatUtils.formatPeriod(date1.getTime(), date2.getTime(), "d"));
    } else {
      d = 0 - Integer
          .parseInt(DurationFormatUtils.formatPeriod(date2.getTime(), date1.getTime(), "d"));
    }
    return d;
  }
  ...
  public static String getISO8601Now() {
    return DateFormatUtils.format(DateUtil.getNow(), "yyyy-MM-dd HH:mm:ss ZZ");
  }
  ...
  public static long getNow(String zone, String locale, int preday) {
    ...
    ca.setTimeInMillis(new Date().getTime() - (long) preday * 24 * 60 * 60 * 1000);
  ...
  public static String toChinaString(Date date) {
    ...
    int month = ca.get(Calendar.MONTH) + 1;
    int day = ca.get(Calendar.DATE);
    return "" + ca.get(Calendar.YEAR) + "年" + (month > 9 ? month : ("0" + month)) + "月"
        + (day > 9 ? day : ("0" + day)) + "日";
  }
  ...
  public static String aftYears(int n) {
    ...
    int month = ca.get(Calendar.MONTH) + 1;
    int day = ca.get(Calendar.DATE);
    return (year + n) + (month < 10 ? "-0" : "-") + month + (day < 10 ? "-0" : "-") + day
        + " 00:00:00";
  }
  ...
  public static String preHours(int hour, DateFormat format) {
    ...
    Calendar ca = Calendar.getInstance();
    ca.clear();
    ca.setTimeInMillis(new Date().getTime() - (long) hour * 60 * 60 * 1000);
    return Format(format, ca.getTime());
  }
  ...
  public final static String[][] MONTHS =
      new String[][] {{"01", "Jan", "January", "Januar", "Gennaio", "Janvier", "janv", "Enero"},
          {"02", "Feb", "February", "Februar", "Febbraio", "Février", "févr", "Febrero"},
          ...
          {"09", "Sep", "September", "September", "Settembre", "Septembre", "septiembre"},
          {"10", "Oct", "October", "Oktober", "Ottobre", "Octobre", "octubre"},
          {"11", "Nov", "November", "November", "Novembre", "Novembre", "noviembre"},
          {"12", "Dec", "December", "Dezember", "Dicembre", "Décembre", "déc", "diciembre"}};
  ...
  public static Date rFormat(DateFormat format, String time) {
    ...
    time = ts[0] + "-" + ts[1] + "-" + ds[0] + " " + ms[0] + ":" + ms[1] + ":" + ms[2];
  ...
  public static Date transformDateStringToDate(DateFormat format, String dateString)
   ...
   * @return
   */
  public static String getDayOfWeek(String date, boolean isFirst, boolean isMonday) {
    Calendar calFirst = Calendar.getInstance();
    Date dd = getDateFromStr(format_yyyyMMdd, date);
    calFirst.setTime(dd);
    Date firstDate = getFirstDayOfWeek(calFirst.getTime(), isMonday);
    return isFirst ? Format(format_yyyyMMdd, firstDate)
        : preDays(Format(format_yyyyMMdd, firstDate), format_yyyyMMdd, -6);
  }
  ...
  public static String getDayOfWeek(int year, int week, boolean isFirst, boolean isMonday) {
    ...
    return isFirst ? Format(format_yyyyMMdd, firstDate)
        : aftDays(6, Format(format_yyyyMMdd, firstDate));
  }
  ...
  public static String preMins(DateFormat format, int min) {
    Calendar ca = Calendar.getInstance();
    ca.clear();
    ca.setTimeInMillis(new Date().getTime() - (long) min * 60 * 1000);
    return Format(format, ca.getTime());
  }
  ...
  /**
   * 30 Aug 20131:37 Monday, July 2, 2012 August 22, 2012 注:必须保证月份是英文的,年份是四位
   * 
   * @param edate
   * @return
   */
  public static String date_format(String edate) {
    edate = edate.replaceAll(",", " ").replaceAll("-", " ").replace(".", " ").replaceAll(" +", " ");
    ...
    for (String date : dates) {
      ...
      } else if (date.matches("[A-Za-z]+$") && 0 == Integer.parseInt(month)) {
  ...
  public static List<String> getDateWeekInterval(String beginDate, String endDate, int week)
      throws ParseException {
    ...
    for (int i = 0; i < 100; i++) {
      ...
      boolean isBefore = beginDate.equals(endDate)
          || DateUtil.parseDateStringToDate(DateUtil.format_yyyyMMdd, beginDate)
              .before(parseDateStringToDate(format_yyyyMMdd, endDate));
      if (isBefore) {
        dates.add(beginDate);
      } else {
        break;
  ...
  public static Date parseDateTime(String timeString) {
    try {
      return org.apache.commons.lang3.time.DateUtils.parseDate(timeString, new String[] {
          "yyyy-MM-dd HH:mm:ss", "yyyy-M-d H:m:s", "yyyy-MM-dd H:m:s", "yyyy-M-d HH:mm:ss"});
    } catch (ParseException e) {
      return null;
    }
  }
